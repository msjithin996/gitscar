...
?>
		...
		<ol id="threesixty_images"></ol>
					...
					{ ?>
						<script>
						alert("sorry 360 not available for this model") </script>
                        <img src="not-found.png" alt="found" width="750" height="162" /></p>
...
$(document).ready(function () {
	...
	var ready = false,
			...
			totalFrames = <?php echo $row['tframes'] ?>,
	...
	*/
	function loadImage() {
		...
		var imageName = "img/<?php echo $row['loc'] ?>/" + (loadedImages + 1) + ".jpg";
		/*
